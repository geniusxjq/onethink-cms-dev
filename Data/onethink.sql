...
) ENGINE=MyISAM AUTO_INCREMENT=90 DEFAULT CHARSET=utf8 ROW_FORMAT=FIXED COMMENT='行为日志表';
...
INSERT INTO `onethink_action_log` VALUES (89,1,1,2130706433,'member',1,'admin在2015-02-16 14:25登录了后台',1,1424067926);
...
CREATE TABLE `onethink_addons` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=MyISAM AUTO_INCREMENT=164 DEFAULT CHARSET=utf8 COMMENT='插件表';
...
INSERT INTO `onethink_addons` VALUES (135,'Friendlinks','友情链接','友情链接',1,'{\"random\":\"1\"}','geniusxjq(app880.com)','http://app880.com','0.1',1423825560,1,1,2);
...
INSERT INTO `onethink_addons` VALUES (158,'Vote','微投票','支持单选、多选的小投票插件。可以用来收集用户对某几个选项的意见。',1,'{\"defaultid\":\"0\",\"display\":\"1\"}','Microrain','','1.0',1423990253,1,0,0);
INSERT INTO `onethink_addons` VALUES (159,'Support','QQ客服','网站QQ客服插件',1,'{\"random\":\"1\",\"QqKEY\":\"\",\"AnliKEY\":\"\",\"sinaKEY\":\"\"}','高龙','','0.1',1424068041,0,0,0);
INSERT INTO `onethink_addons` VALUES (163,'ImportData','数据导入','这是一个用于从其他博客导入到OneThink的后台插件，目前支持WordPress,主要导入分类和文章！',1,'null','IT童老','','0.1',1424068706,1,0,0);
