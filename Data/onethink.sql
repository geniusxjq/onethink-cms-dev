...
CREATE TABLE `onethink_addons` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=MyISAM AUTO_INCREMENT=109 DEFAULT CHARSET=utf8 COMMENT='插件表';
...
INSERT INTO `onethink_addons` VALUES (82,'Comment','评论功能','用于各种类型文档评论',1,'null','Wolixli','0.1',1422871179,1,0,3);
...
INSERT INTO `onethink_addons` VALUES (96,'Friendlinks','友情链接','友情链接',1,'{\"random\":\"1\"}','geniusxjq(app880.com)','0.1',1423065141,1,0,5);
INSERT INTO `onethink_addons` VALUES (100,'Guestbook','留言板','这是一个简单的留言板',1,'{\"display\":\"1\",\"messages_check\":\"1\"}','geniusxjq(ap880.com)','0.2',1423131727,1,0,4);
INSERT INTO `onethink_addons` VALUES (102,'Schedule','计划任务','执行计划任务插件',1,'{\"random\":\"1\"}','iszhang','0.1',1423148478,1,0,6);
INSERT INTO `onethink_addons` VALUES (103,'Advs','广告管理','广告插件',1,'null','onep2p','0.1',1423235238,1,0,8);
INSERT INTO `onethink_addons` VALUES (104,'Advertising','广告位置','广告位插件',1,'null','onep2p','0.1',1423235264,1,0,7);
...
INSERT INTO `onethink_member` VALUES (1,'admin',0,'0000-00-00','',20,32,0,1422599239,2130706433,1423546742,1);
...
INSERT INTO `onethink_ucenter_member` VALUES (1,'admin','ecfb4272feb1d1fd11fc719c45b5e21d','836692464@qq.com','',1422599239,2130706433,1423546742,2130706433,1422599239,1);
