...
--
-- Host: 127.0.0.1
-- Generation Time: 2016-08-01 07:33:31
-- 服务器版本： 5.5.39
-- PHP Version: 5.4.31
...
--
-- 转存表中的数据 `onethink_advertisement`
--
...
--
-- Indexes for table `onethink_advertisement`
--
ALTER TABLE `onethink_advertisement`
 ADD PRIMARY KEY ("id");

--
-- Indexes for table `onethink_advertising`
--
...
--
-- Indexes for table `onethink_avatar`
--
...
--
-- Indexes for table `onethink_comment`
--
...
--
-- Indexes for table `onethink_friendlinks`
--
ALTER TABLE `onethink_friendlinks`
 ADD PRIMARY KEY ("id");

--
-- Indexes for table `onethink_guestbook`
--
...
--
-- Indexes for table `onethink_mail_history`
--
ALTER TABLE `onethink_mail_history`
 ADD PRIMARY KEY ("id");

--
-- Indexes for table `onethink_mail_history_link`
--
ALTER TABLE `onethink_mail_history_link`
 ADD PRIMARY KEY ("id");

--
-- Indexes for table `onethink_mail_list`
--
ALTER TABLE `onethink_mail_list`
 ADD PRIMARY KEY ("id");

--
-- Indexes for table `onethink_mail_token`
--
...
--
-- Indexes for table `onethink_module`
--
...
--
-- Indexes for table `onethink_schedule`
--
ALTER TABLE `onethink_schedule`
 ADD PRIMARY KEY ("id");

--
-- Indexes for table `onethink_sensitive`
--
...
--
-- Indexes for table `onethink_vote`
--
ALTER TABLE `onethink_vote`
 ADD PRIMARY KEY ("id");

--
-- Indexes for table `onethink_wechat_message`
--
