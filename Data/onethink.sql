...
INSERT INTO `onethink_addons` VALUES (135,'Friendlinks','友情链接','友情链接',1,'{\"random\":\"1\"}','geniusxjq(app880.com)','http://app880.com','0.1',1423825560,1,0,3);
INSERT INTO `onethink_addons` VALUES (136,'Advs','广告管理','广告插件',1,'null','onep2p','','0.1',1423825694,1,0,4);
INSERT INTO `onethink_addons` VALUES (137,'Advertising','广告位置','广告位插件',1,'null','onep2p','','0.1',1423825700,1,0,5);
INSERT INTO `onethink_addons` VALUES (138,'Guestbook','留言板','这是一个简单的留言板',1,'{\"display\":\"1\",\"messages_check\":\"1\"}','geniusxjq(app880.com)','http://app880.com','0.2',1423825869,1,0,2);
INSERT INTO `onethink_addons` VALUES (140,'SyncLogin','第三方账号同步登陆','第三方账号同步登陆',1,'{\"type\":null,\"meta\":\"\",\"QqKEY\":\"\",\"QqSecret\":\"\",\"SinaKEY\":\"\",\"SinaSecret\":\"\"}','yidian','','0.1',1423825967,0,0,0);
INSERT INTO `onethink_addons` VALUES (143,'ReturnTop','返回顶部','回到顶部美化，随机或指定显示，100款样式，每天一种换，天天都用新样式',1,'{\"random\":\"0\",\"current\":\"1\"}','thinkphp','','0.1',1423826511,0,0,0);
INSERT INTO `onethink_addons` VALUES (145,'Wechat','微信','微信插件',1,'{\"url\":\"http:\\/\\/localhost\\/admin.php?s=\\/Home\\/Addons\\/execute\\/_addons\\/Wechat\\/_controller\\/Wechat\\/_action\\/index\\/ukey\\/2p7IL5s0unBArSH.html\",\"ukey\":\"2p7IL5s0unBArSH\",\"token\":\"3Osv1aCDV2dcmjEp9XZAuKiHyehJWb\",\"appid\":\"\",\"appsecret\":\"\",\"codelogin\":\"0\",\"codeloginlocation\":null,\"default\":null,\"subscribe\":null,\"button\":null}','huay1','','1.0',1423827001,1,0,0);
...
INSERT INTO `onethink_addons` VALUES (148,'Unslider','焦点图','焦点图',1,'{\"title\":\"Uslider\",\"display\":\"1\"}','cepljxiongjun','','0.1',1423837388,0,0,0);
...
INSERT INTO `onethink_hooks` VALUES (4,'documentDetailAfter','文档末尾显示',1,1423761366,'Attachment,SocialComment,BaiduShare',1);
...
INSERT INTO `onethink_hooks` VALUES (13,'AdminIndex','首页小格子个性化显示',1,1382596073,'SiteStat,SystemInfo,DevTeam,Water,Mail',1);
...
INSERT INTO `onethink_hooks` VALUES (27,'pageFooter','页面footer钩子，一般用于加载插件JS文件和JS代码',1,1422719676,'Mail,ReturnTop,Unslider',1);
...
INSERT INTO `onethink_hooks` VALUES (88,'Guestbook','调用（显示）留言板的钩子',1,1423825869,'Guestbook',1);
INSERT INTO `onethink_hooks` VALUES (89,'SyncLogin','调用第三方账号同步登陆的钩子',1,1423825967,'SyncLogin',1);
INSERT INTO `onethink_hooks` VALUES (95,'WechatAdminLogin','后台登陆页面钩子，用于微信二维码登陆',1,1423827001,'Wechat',1);
INSERT INTO `onethink_hooks` VALUES (96,'WechatIndexLogin','前台登陆页面钩子，用于微信二维码登陆',1,1423827001,'Wechat',1);
INSERT INTO `onethink_hooks` VALUES (97,'Unslider','图片轮播（焦点图）插件钩子',1,1423837388,'Unslider',1);
